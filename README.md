...
- Kiali를 활용한 실시간 Traffic Tracing 대시보드 지원
...
- Sealed Secrets
- Bash Script / Nix Package Manager
...
### K3s 기반 온프레미스 클러스터 프로비저닝 (선택)

로컬 / 온프레미스 머신을 기반으로 K3s 싱글 노드 클러스터를 프로비저닝 하실 수 있습니다.
